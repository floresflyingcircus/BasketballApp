...
describe GamesController do
  ...
  let(:valid_attributes) { { "date" => "2013-05-29" } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested game" do
        ...
        Game.any_instance.should_receive(:update_attributes).with({ "date" => "2013-05-29" })
        put :update, {:id => game.to_param, :game => { "date" => "2013-05-29" }}, valid_session
      end
