...
describe StatsController do
  ...
  let(:valid_attributes) { { "two_made" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved stat as @stat" do
        ...
        post :create, {:stat => { "two_made" => "invalid value" }}, valid_session
        assigns(:stat).should be_a_new(Stat)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested stat" do
        ...
        Stat.any_instance.should_receive(:update_attributes).with({ "two_made" => "1" })
        put :update, {:id => stat.to_param, :stat => { "two_made" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the stat as @stat" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Stat.any_instance.stub(:save).and_return(false)
        put :update, {:id => stat.to_param, :stat => { "two_made" => "invalid value" }}, valid_session
        assigns(:stat).should eq(stat)
      end
